...
#include "Graphic/ActiveTriangleArray.h"
#include "Math/Math.h"
...
class Object
{
    ...
    ActiveTriangleArray m_aActiveTriangles;
public:
    ...
    void Accept(Step* visitor);

    void Update(const Matrix& mat);

    void Update( void );

    inline ActiveTriangleArray& GetActiveTriangles( void ) { return m_aActiveTriangles; }
    inline const ActiveTriangleArray& GetActiveTriangles( void ) const { return m_aActiveTriangles; }
